...
module.exports = tseslint.config(
  ...
  // tout le reste doit passer par TenantScopedPrismaService (RLS forcée).
  {
    ...
    ignores: [
      ...
      // Corrige BIL-12 (docs/audit/BILLING-AUDIT.md) : même catalogue non
      // tenant-scoped que plans.service.ts ci-dessus, chemin d'écriture
      // Super Admin plutôt que lecture publique.
      "src/plans-admin/plans-admin.repository.ts",
