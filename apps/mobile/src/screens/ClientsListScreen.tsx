...
import { useCustomers, useDeactivateCustomer } from "../lib/queries/use-customers";
import type { AppStackParamList } from "../navigation/types";

type Props = NativeStackScreenProps<AppStackParamList, "ClientsList">;
...
export function ClientsListScreen({ navigation }: Props) {
  ...
  useLayoutEffect(() => {
    navigation.setOptions({
      headerRight: () => (
        <Pressable onPress={() => navigation.navigate("ClientForm", undefined)} hitSlop={8}>
  ...
  return (
    <View style={styles.container}>
      ...
      {customersQuery.isLoading ? <ActivityIndicator style={styles.loader} /> : null}
      {customersQuery.isError ? <Text style={styles.errorText}>Impossible de charger les clients.</Text> : null}
